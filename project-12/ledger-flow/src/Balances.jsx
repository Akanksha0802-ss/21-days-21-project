    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
      <div className="bg-slate-900 rounded-2xl p-6 text-white shadow-lg border border-slate-800">
        <div className="flex items-center justify-between mb-4">
          ...
          <span className="text-xs font-medium uppercase tracking-wider text-amber-100">Total Balance</span>
        </div>
        <h2 className="text-3xl font-bold tracking-tight">${totalBalance.toLocaleString()}</h2>
      </div>

      <div className="bg-cyan-50 rounded-2xl p-6 shadow-sm border border-slate-200">
        <div className="flex items-center justify-between mb-4">
      ...
      <div className="md:col-span-3 bg-cyan-50 rounded-2xl p-6 shadow-sm border border-slate-200">
