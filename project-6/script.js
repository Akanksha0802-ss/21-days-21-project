const schema = [
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "text",
        placeholder: "Entry-Level Web Developer",
      },
      {
        key: "summary",
        label: "Profile Summary",
        type: "textarea",
        placeholder: "Brief summary highlighting your skills, goals, and strengths",
        rows: 3,
      },
    ],
  },
    ...
    fields: [
      {
        ...
        type: "text",
        placeholder: "HTML, CSS, JavaScript, C++, SQL",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    repeatable: true,
    fields: [
      { key: "school", label: "College / University", type: "text" },
      { key: "degree", label: "Degree / Course", type: "text" },
      { key: "period", label: "Duration", type: "text" },
      { key: "details", label: "Additional Details (CGPA, Honors, etc.)", type: "textarea", rows: 2 },
    ],
  },
];
  ...
  minimal: {
    ...
    render: (data) => `
      <header>
        ...
        <p class="text-muted">${data.role || "Professional Title"}</p>
        <p>${joinValues(
      ...
      ${drawListSection(
        ...
        (item) => `
          ...
          item.company || "Company"
            ...
            <div class="text-muted">${item.period || "Duration"}</div>
        ...
        ${drawCardList(
          ...
          (item) => `
            <div>
              ...
              <div class="text-muted small">${item.school || "Institution"} · ${
...
function defaultSummary() {
  ...
  return "Motivated professional with a strong focus on clarity, structure, and impact. Designed to highlight skills, experience, and achievements in a clean and recruiter-friendly format.";
}

//part-7 done

//part-8 bind ui functions
//watch section
function bindUI() {
  if (templateCount) {
